...
* **5%** of every harvest in the [Automatic](../products/staking-wigo-wigobank/staking-vs.-liquid-staking.md) staking pool (Performance Fee) in the WigoBank.
* **0.5%** of every unstake within three days in the [Automatic](../products/staking-wigo-wigobank/staking-vs.-liquid-staking.md) staking pool in the WigoBank.
